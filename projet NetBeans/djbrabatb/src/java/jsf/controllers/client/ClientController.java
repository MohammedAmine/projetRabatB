package jsf.controllers.client;

import persistence.Client;
import jsf.controllers.client.util.JsfUtil;
import jsf.controllers.client.util.JsfUtil.PersistAction;
...
public class ClientController implements Serializable {
    ...
    @EJB
    private businessLogic.ClientFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/langages").getString("ClientCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/langages").getString("ClientUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/langages").getString("ClientDeleted"));
        if (!JsfUtil.isValidationFailed()) {
        ...
        if (selected != null) {
            ...
            try {
                ...
                if (msg.length() > 0) {
                    ...
                    JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("/langages").getString("PersistenceErrorOccured"));
                }
            } catch (Exception ex) {
    ...
    public static class ClientControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Client) {
                ...
                return getStringKey(o.getUtilisateurID());
            } else {
